...
exports.UUID = class UUID
  ...
  #
  # The `UUID.generate` function generates a new UUID. UUIDs generated by this function
  ...
  # ## Binding the UUID Generator to Other Classes
  # The `UUID.bind` method will bind the UUID generator to some other class, that is, it will
  # add the `getUUID` method to the class prototype.
  # The `getUUID` method returns the UUID of a object. UUIDs are generated lazily,
  # on the first time `getUUID()` is called for that object.
